...
module HeadHunterApi
  module Retryable
    ...
    DEFAULT_ERROR_CLASSES = [
      HeadHunterApi::Errors::CaptchaRequired,
      HeadHunterApi::Errors::TooManyRequests
    ].freeze
    ...
    def with_retries(*args)
      ...
      options[:max_retry] ||= HeadHunterApi.configuration.max_retry
      options[:sleep_time] ||= HeadHunterApi.configuration.request_sleep_time
      options[:sleep_multiplier] ||= HeadHunterApi.configuration.sleep_multiplier
